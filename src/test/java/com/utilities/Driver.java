...
public class Driver {
    ...
    public static WebDriver getDriver(){
        ...
        if (driver == null){
            ...
            /*
            Depending on the browserType that will be return from configuration.properties file switch statement will determine the case, and upen the matching browser
             */
            switch (browserType){
                case "chrome":
